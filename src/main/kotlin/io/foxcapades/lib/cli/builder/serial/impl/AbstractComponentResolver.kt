  ...
  : Iterator<ResolvedComponent>
{
  ...
  protected fun KCallable<*>.relevantAnnotations(): RelevantAnnotations {
    ...
    val fn = when (this) {
      is KProperty<*> -> { t: KClass<out T>, a: KClass<out Annotation> -> makeDuplicateAnnotationsError(t, a) }
      is KFunction<*> -> { t: KClass<out T>, a: KClass<out Annotation> -> makeDuplicateAnnotationsError(t, a) }
      else -> BUG()
    }
